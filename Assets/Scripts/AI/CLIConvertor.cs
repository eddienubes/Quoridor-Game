...
namespace Quorridor.AI
{
    ...
    public static class CLIConvertor
    {
        ...
        private static string GetCellCoord(Cell cell) => $"{'A' + cell.GridX - 1}{cell.GridY}";
